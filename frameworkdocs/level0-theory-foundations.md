...
Common UI patterns — filling dropdowns, handling autocomplete fields, interacting with OrangeHRM's custom date pickers, waiting for toast notifications, handling confirmation dialogs — are extracted into reusable helper methods. Page objects call these helpers instead of each implementing their own version of the same interaction.

What you gain: consistent handling of complex UI patterns, less code in page objects
